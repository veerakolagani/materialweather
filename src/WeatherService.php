...
namespace Drupal\materialweather;
...
class WeatherService {
  ...
  public function createRequest($options) {
    $query = [];
    $appid_config = '9c7424d24207862e3599f6e2c3aa4c3a';
  ...
  public function getWeatherInformation($options) {
    try {
      ...
      watchdog_exception('materialweather', $e);
      return FALSE;
    }
  ...
  public function getCurrentWeatherInformation($output, $config) {
    ...
    $build[] = [
      '#theme' => 'materialweather',
      '#materialweather_detail' => $html,
      '#attached' => array(
        'library' => array(
          'materialweather/materialweather_theme',
        ),
      ),
  ...
  public function getHourlyForecastWeatherInformation($output, $config) {
    ...
    $build[] = [
      '#theme' => 'materialweather_hourlyforecast',
      '#hourlyforecast_detail' => $html,
      '#attached' => array(
        'library' => array(
          'materialweather/materialweatherhourlyforecast_theme',
        ),
      ),
      '#cache' => array('max-age' => 0),
    ];
  ...
  public function getDailyForecastWeatherInformation($output, $config) {
    ...
    $build[] = [
      '#theme' => 'materialweather_dailyforecast',
      '#dailyforecast_detail' => $html,
      '#attached' => array(
        'library' => array(
          'materialweather/materialweatherdailyforecast_theme',
        ),
      ),
      '#cache' => array('max-age' => 0),
    ];
